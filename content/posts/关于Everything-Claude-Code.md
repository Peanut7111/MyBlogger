...
- **技能丰富**：涵盖前端、后端、代码审查、测试等多种领域
- **即插即用**：安装后即可在 Claude Code 中使用
- **持续更新**：社区活跃，不断有新技能加入
...
Everything Claude Code 让 Claude Code 的能力得到极大扩展，是每位开发者都应该了解的工具。

---

*持续探索，让 AI 成为你最好的编程伙伴！*

相关术语可参考 [**AI术语笔记**](/MyBlogger/posts/ai-glossary/)
